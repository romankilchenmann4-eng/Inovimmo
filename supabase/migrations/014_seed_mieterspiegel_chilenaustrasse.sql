...
BEGIN
  ...
  -- LIEGENSCHAFTEN
  -- ============================================================
  INSERT INTO liegenschaften (id, verwalter_id, eigentuemer_id, name, strasse, hausnummer, plz, ort, kanton, anzahl_wohnungen, objekttyp)
  VALUES (
    gen_random_uuid(), v_verwalter_id, v_verwalter_id,
  ...
  -- ============================================================
  -- NK VERTEILSCHLÜSSEL — Default allocation methods per category
  -- ============================================================
  INSERT INTO nk_verteilschluessel (liegenschaft_id, kategorie, verteilschluessel_typ)
  VALUES
    (v_lieg_15, 'heizung', 'flaeche'),
    (v_lieg_15, 'warmwasser', 'flaeche'),
    (v_lieg_15, 'wasser_abwasser', 'kopf'),
    (v_lieg_15, 'kehricht', 'kopf'),
    (v_lieg_15, 'allgemeinstrom', 'gleich'),
    (v_lieg_15, 'hauswart', 'gleich'),
    (v_lieg_15, 'versicherung', 'gleich'),
    (v_lieg_15, 'sonstiges', 'gleich')
  ON CONFLICT (liegenschaft_id, kategorie) DO NOTHING;

  INSERT INTO nk_verteilschluessel (liegenschaft_id, kategorie, verteilschluessel_typ)
  VALUES
    (v_lieg_17, 'heizung', 'flaeche'),
    (v_lieg_17, 'warmwasser', 'flaeche'),
    (v_lieg_17, 'wasser_abwasser', 'kopf'),
    (v_lieg_17, 'kehricht', 'kopf'),
    (v_lieg_17, 'allgemeinstrom', 'gleich'),
    (v_lieg_17, 'hauswart', 'gleich'),
    (v_lieg_17, 'versicherung', 'gleich'),
    (v_lieg_17, 'sonstiges', 'gleich')
  ON CONFLICT (liegenschaft_id, kategorie) DO NOTHING;

  RAISE NOTICE 'Mieterspiegel seed completed: 2 Liegenschaften, 18 Wohnungen, 17 Mieter, 18 Mietverhältnisse, 16 Verteilschluessel';
END $$;